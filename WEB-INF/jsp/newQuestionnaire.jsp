...
<head>
	...
	<script src="/quest/js/jquery-1.10.2.js"></script>
        <script type="text/javascript">
        function doAjaxPost() {
        // get the form values
        $.ajax({
        	
        	    url: "/quest/control/saveAnswers", 
        	    type: 'POST', 
        	    dataType: 'json', 
        	    ...
        	    success: function(data) { 
        	        alert(data.id + " |||| " + data.name+"|||"+data.fir) ;
        	    },
...
<form:form method="post" action="add.html" commandName="questionnaire">
	...
	<tr>
		<td colspan="2">
		<input type="button" value="ajx-call" name="restAjaxCall" onclick="doAjaxPost()">
